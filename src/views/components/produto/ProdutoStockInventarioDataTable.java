...
public class ProdutoStockInventarioDataTable extends AbstractDynamicDataTable<StockProduto> {

    public ProdutoStockInventarioDataTable(List<StockProduto> data){
